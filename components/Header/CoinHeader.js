...
export default class CoinHeader extends React.Component {
  ...
  render() {
    ...
    if (this.props.shouldSpin) {
      coinImage = (
        <Animated.Image
          source={require("../../assets/images/glowcoin.png")}
          style={{
            width: 70,
            height: 70,
            resizeMode: "contain",
    ...
    return (
      ...
      >
        <View style={{ flex: 1 }}>{coinImage}</View>
        <Text style={{ flex: 1, fontSize: 20, color: "white", marginLeft: 10 }}>
          {this.props.navigation.getParam("points", 0)}
        </Text>
      </TouchableOpacity>
    );
  }
